...
troshx_sos_vue_combat_components_DollView.prototype = $extend(haxevx_vuex_core_VComponent.prototype,{
	...
	,getArmorPartPropsOf: function(name,index) {
		...
		var hitLocIndex = this.viewModel.DOLL_PART_HitIndices[index];
		var locations = this.coverageHitLocations;
		var avs = this.hitLocationArmorValues;
		var av = avs[locations[hitLocIndex].id];
	...
	,get_coverageHitLocations: function() {
		return this.currentOpponent.charSheet.body.hitLocations;
	}
	...
	,get_hitLocationArmorValues: function() {
		...
		var ch = this.coverageHitLocations;
		var body = this.currentOpponent.charSheet.body;
		var targMask = 0;
