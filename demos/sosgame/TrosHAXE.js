...
troshx_sos_vue_combat_components_DollView.prototype = $extend(haxevx_vuex_core_VComponent.prototype,{
	...
	,get_armorColorScale: function() {
		return ["#ff0000","#c00000","#e26b0a","#f79646","#ffff00","#9bbb59","#92d050","#00b050","#0070c0","#00b0f0"];
	}
	...
	,get_armorDollColors: function() {
		...
		while(_g1 < _g) {
			...
			var aggre = av.avc + av.avb + av.avc;
			var gotAV = aggre > 0;
			aggre /= 3;
	...
	,get_hitLocationArmorValues2: function() {
		return this.getHitLocationArmorValues(this.hitLocationZeroAVValues2,2);
	}
