...
troshx_sos_vue_combat_components_DollView.prototype = $extend(haxevx_vuex_core_VComponent.prototype,{
	...
	,get_opponents: function() {
		var _this = this.viewModel;
		var player = _this.currentPlayerIndex >= 0 ? _this.boutModel.bout.combatants[_this.currentPlayerIndex] : null;
		if(player == null) {
			return null;
		} else {
			return null;
	...
	,_Init: function() {
		...
		this.computed = { focusedTextLbl : clsP.get_focusedTextLbl, player : clsP.get_player, opponents : clsP.get_opponents, dollScale : clsP.get_dollScale, thrustPointStyle : clsP.get_thrustPointStyle, clampedOpponentIndex : clsP.get_clampedOpponentIndex, currentOpponent : clsP.get_currentOpponent};
		this.methods = { getPartPropsOf : clsP.getPartPropsOf, getSwingPropsOf : clsP.getSwingPropsOf, layoutViewPropsOf : clsP.layoutViewPropsOf, get_focusedTextLbl : clsP.get_focusedTextLbl, get_player : clsP.get_player, get_opponents : clsP.get_opponents, get_dollScale : clsP.get_dollScale, get_thrustPointStyle : clsP.get_thrustPointStyle, get_clampedOpponentIndex : clsP.get_clampedOpponentIndex, get_currentOpponent : clsP.get_currentOpponent, setupNewGame : clsP.setupNewGame, setupUIInteraction : clsP.setupUIInteraction, handleImageMap : clsP.handleImageMap, onResize : clsP.onResize, refreshLayout : clsP.refreshLayout};
	}
