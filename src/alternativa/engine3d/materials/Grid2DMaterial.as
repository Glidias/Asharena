...
package alternativa.engine3d.materials {
	 ...
	 */
	public class Grid2DMaterial extends Material {
		...
		/**
		 * Creates a new Grid2DMaterial instance.
		 * @param color Color .
		 * @param alpha Transparency.
		 */
		public function Grid2DMaterial(color:uint = 0x7F7F7F, alpha:Number = .99, gridSquareWidth:Number=32, gridSquareHeight:Number=32) {
			this.color = color;
			this.alpha = alpha;
		...
		private function setupProgram(object:Object3D):Grid2DMaterialProgram {
			...
			return new Grid2DMaterialProgram(vertexLinker, fragmentLinker);
		}
		...
		override alternativa3d function collectDraws(camera:Camera3D, surface:Surface, geometry:Geometry, lights:Vector.<Light3D>, lightsLength:int, useShadow:Boolean, objectRenderPriority:int = -1):void {
			...
			var program:Grid2DMaterialProgram = programsCache[object.transformProcedure];
			if (program == null) {
		...
		override public function clone():Material {
			var res:Grid2DMaterial = new Grid2DMaterial(color, alpha);
...
class Grid2DMaterialProgram extends ShaderProgram {
	...
	public function Grid2DMaterialProgram(vertex:Linker, fragment:Linker) {
