...
package alternativa.engine3d.materials {
	...
	/**
	 * This is a TextureMaterial that clips by z-value. Crappy A3D tons of Code Duplication!!
	 * 
	 ...
	 */
	public class TextureZClipMaterial extends Material {
		...
		/**
		 * Creates a new TextureZClipMaterial instance.
		 *
		 * @param diffuseMap Diffuse map.
		 * @param alpha Transparency.
		 */
		public function TextureZClipMaterial(diffuseMap:TextureResource = null, opacityMap:TextureResource = null, alpha:Number = 1) {
		...
		private function getProgram(object:Object3D, programs:Vector.<TextureZClipMaterialProgram>, camera:Camera3D, opacityMap:TextureResource, alphaTest:int):TextureZClipMaterialProgram {
			...
			if (program == null) {
				...
				program = new TextureZClipMaterialProgram(vertexLinker, fragmentLinker);
		...
		private function getDrawUnit(program:TextureZClipMaterialProgram, camera:Camera3D, surface:Surface, geometry:Geometry, opacityMap:TextureResource):DrawUnit {
		...
		override alternativa3d function collectDraws(camera:Camera3D, surface:Surface, geometry:Geometry, lights:Vector.<Light3D>, lightsLength:int, useShadow:Boolean, objectRenderPriority:int = -1):void {
			...
			var optionsPrograms:Vector.<TextureZClipMaterialProgram> = programsCache[object.transformProcedure];
			if(optionsPrograms == null) {
				optionsPrograms = new Vector.<TextureZClipMaterialProgram>(6, true);
				programsCache[object.transformProcedure] = optionsPrograms;
			}

			var program:TextureZClipMaterialProgram;
		...
		override public function clone():Material {
			var res:TextureZClipMaterial = new TextureZClipMaterial(diffuseMap, opacityMap, alpha);
		...
		override protected function clonePropertiesFrom(source:Material):void {
			...
			var tex:TextureZClipMaterial = source as TextureZClipMaterial;
...
class TextureZClipMaterialProgram extends ShaderProgram {
	...
	public function TextureZClipMaterialProgram(vertex:Linker, fragment:Linker) {
