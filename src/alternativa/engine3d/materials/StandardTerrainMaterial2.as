...
package alternativa.engine3d.materials {
	...
	/**
	 * Same as StandardMaterialTerrainMaterial but supports seperate UVs for normal map and diffuse map, fog and mist and forceRenderPriority!
	 * 
	 ...
	 */
	public class StandardTerrainMaterial2 extends TextureMaterial implements ILODTerrainMaterial {
...
//		private static const OBJECT_TYPE_BIT:int = 19;
    ...
    static alternativa3d const _passUVProcedure:Procedure = new Procedure(["#v0=vUV", "#v1=vUV1", "#a0=aUV", "#c0=cUVProperties",  "#c1=cTiling",
		"mov t0, a0",
		 ...
		 */
		public function StandardTerrainMaterial2(diffuseMap:TextureResource = null, normalMap:TextureResource = null, specularMap:TextureResource = null, glossinessMap:TextureResource = null, opacityMap:TextureResource = null) {
...
//			fragmentLinker.setInputParams(omniMulShadowProcedure, "tNormal", "tViewVector", "tTotalLight", "cAmbientColor");
		 ...
		 * @param lightsLength
		 */
		private function getProgram(object:Object3D, programs:Array, camera:Camera3D, materialKey:int, opacityMap:TextureResource, alphaTest:int, lightsGroup:Vector.<Light3D>, lightsLength:int, isFirstGroup:Boolean, shadowedLight:Light3D):StandardTerrainMaterialProgram {
			// 0 bit - lightmap
			...
			if (program == null) {
				...
				program = new StandardTerrainMaterialProgram(vertexLinker, fragmentLinker, (shadowedLight != null) ? 1 : lightsLength);
		...
		private function addDrawUnits(program:StandardTerrainMaterialProgram, camera:Camera3D, surface:Surface, geometry:Geometry, opacityMap:TextureResource, lights:Vector.<Light3D>, lightsLength:int, isFirstGroup:Boolean, shadowedLight:Light3D, opaqueOption:Boolean, transparentOption:Boolean, objectRenderPriority:int):void {
			...
			drawUnit.setVertexConstantsFromNumbers(program.cUVProperties, uvOffsetX, uvOffsetY, 1 / pageSize, uvMultiplier);
			drawUnit.setVertexConstantsFromNumbers(program.cTiling, uvMultiplier2, uvMultiplier2, uvMultiplier2, uvMultiplier2);
		...
		override alternativa3d function collectDraws(camera:Camera3D, surface:Surface, geometry:Geometry, lights:Vector.<Light3D>, lightsLength:int, useShadow:Boolean, objectRenderPriority:int = -1):void {
			...
			// Iterate groups
			var materialKey:int;
			var program:StandardTerrainMaterialProgram;
		...
		override public function clone():Material {
			var res:StandardTerrainMaterial2 = new StandardTerrainMaterial2(diffuseMap, normalMap, specularMap, glossinessMap, opacityMap);
		...
		public function visit(cd:QuadChunkCornerData, root:QuadTreePage, patchShift:int, lookupIndex:int):void 
		{
			...
			//uvMultiplier2 = .5;
		//	pageSize = root.Level  
			// TODO: determine pageSize from root.
		}
		...
		override protected function clonePropertiesFrom(source:Material):void {
			...
			var sMaterial:StandardTerrainMaterial2 = StandardTerrainMaterial2(source);
...
class StandardTerrainMaterialProgram extends ShaderProgram {
	...
	public function StandardTerrainMaterialProgram(vertex:Linker, fragment:Linker, numLigths:int) {
	...
	override public function upload(context3D:Context3D):void {
		...
		cCameraPosition = vertexShader.findVariable("cCameraPosition");
			...
			cTiling = vertexShader.findVariable("cTiling");
