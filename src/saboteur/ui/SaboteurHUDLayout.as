package saboteur.ui 
{
	 ...
	 * @author Glenn Ko
	 */
	public class SaboteurHUDLayout extends Sprite
	{
		...
		public var crosshairCenter:Shape = new Shape();
		
		
		private var stageBounds:ViewPortBounds = new ViewPortBounds();
		private var _stage:Stage;
		public const onLayoutUpdate:Signal2 = new Signal2();
		...
		*/	
		...
		public function SaboteurHUDLayout(stager:Stage=null) 
		{
			_stage = stager;
			stager =  stage;
		...
		private function onNextFrame(e:Event):void 
		{
			...
			updateStage();
			onLayoutUpdate.dispatch(stage.stageWidth*.5, stage.stageHeight*.5);
		}
