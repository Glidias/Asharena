package recast 
{
	...
	public class RecastWorkerBridge extends AS3WorkerBridge
	{
		...
		public static const CMD_ACTIVATE:int = 7;  // re-activate enterFrame. 
		public static const CMD_DEACTIVATE:int = 8;  // deactivate enterFrame. Responses via toMainChannelSync.
