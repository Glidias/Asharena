package tests.pathbuilding
{
	...
	public class TestPathBuilding3rdPerson extends Sprite
	{
		...
		public function TestPathBuilding3rdPerson() 
		{
			...
			_template3D.cameraController = _simpleFlyController =  new SimpleFlyController( new EllipsoidCollider(32, 32, 32), null, stage, new Object3D, _template3D.settings.cameraSpeed, _template3D.settings.cameraSpeedMultiplier, 1);
