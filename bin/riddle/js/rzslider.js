  ...
  Slider.prototype = {
    ...
    positionTrackingHandle: function(newValue, newOffset)
    {
      if(this.range)
      {
		...
		if (this.tracking === 'rzSliderModel' && newValue < this.scope.rzSliderMin) {
			newValue = this.scope.rzSliderMin;
			//return;
		}
		if (this.tracking === 'rzSliderModel' && newValue > this.scope.rzSliderMax) {
			newValue = this.scope.rzSliderMax;
			//return;
		}
